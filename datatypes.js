...
// }
// else{
//     console.log("second is greater oe equal");
// }
...
// let arry1=[1,2,3]
// let arry2=[4,5,6]
// combineArry=arry1.concat(arry2)
...
// let arry1=[1,2,3]
// let arry2=[2,3,4]
// let commomElement=arry1.filter(element.include => arry2.includes(elememt))
// console.log(commomElement);
...
// let str ='Hello world'
// console.log(str.startsWith('H') && str.endsWith('e'));
//  let str2 ='Hello me'
//  console.log(str2.startsWith('H') && str2.endsWith('e'));
...
// let str='Hello Everyone Hello'
// let x=(str.replaceAll("Hello","Hi"));
// console.log(x);
...
// }
// else{
//     console.log("this is not palidrom");
// }
...
// let str=" hello ravi "
// console.log(str);
// let trimmed=(str.trimStart() && str.trimEnd());
// if(trimmed===""){
...
//         newStr=str.replaceAll("Hello","Hi")
//         console.log(newStr);
